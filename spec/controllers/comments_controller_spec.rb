...
RSpec.describe CommentsController, type: :controller do
  ...
  context 'a user without permission to set state' do
    ...
    it 'cant change a state by passing through state_id' do
      post :create, 				comment: { text: 'Cant touch this!', state_id: state.id },
                        ticket_id: ticket.id
      ticket.reload
  ...
  context 'a user with permission to change state' do
    ...
    it 'can change states' do
      post :create, 				comment: { text: 'Call yourself a user?', state_id: state.id },
                        ticket_id: ticket.id
      ticket.reload
  ...
  context 'a admin user with permission to change state' do
    ...
    it 'can change states' do
      post :create, 				comment: { text: 'Administer this knunkle head!', state_id: state.id },
                        ticket_id: ticket.id
      ticket.reload
